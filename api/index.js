 ...
 * GET /api/create-key
 * Returns a new API key for authentication
 */
 ...
 * GET /api/apikey=&url=
 * Example: /api/apikey=YOUR_API_KEY&url=https://google.com
 */
app.get('/api/apikey', (req, res) => {
  ...
  if (!originalUrl) {
    return res.status(400).json({
      success: false,
      error: 'URL parameter is required. Usage: /api/apikey=YOUR_KEY&url=YOUR_URL'
    });
  }
...
app.listen(PORT, () => {
  ...
  console.log(`   GET /api/apikey=&url=`);
